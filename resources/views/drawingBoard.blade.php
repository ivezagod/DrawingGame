...
<h2 class="text-center text-pink-600 font-bold text-5xl mt-[70px]  ">{{$title}}</h2>
    <section class="container flex mx-auto mt-[30px]  ">

        <div id="toolbar" class="bg-transparent border border-pink-600 text-center rounded-md p-5 flex flex-col float-left shadow-blue">
...
{{--            </form>--}}
        ...
        <div class="max-w-[1100px] w-full ml-10   mx-auto">
